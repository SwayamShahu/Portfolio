...
import {
  ...
  ScrollText, TerminalSquare, GraduationCap,
  type LucideIcon,
} from "lucide-react"
...
export const windows: WindowDef[] = [
  ...
  { id: "blogs",      title: "Research",   icon: BookOpen,       width: 660, height: 550, offsetX:  10, offsetY: -10, component: Blogs },
  ...
  { id: "certificates", title: "Certificates", icon: GraduationCap, width: 520, height: 500, offsetX: -40, offsetY: -25, component: Certificates },
]
